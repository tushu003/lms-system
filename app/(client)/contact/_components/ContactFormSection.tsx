...
export default function ContactFormSection(): JSX.Element {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setSuccess("Your message was sent successfully. We'll get back to you soon!");
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-violet-50">
                  {/* mail icon */}
                  <svg className="w-5 h-5 text-violet-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 8.5l9 6 9-6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><rect x="3" y="5" width="18" height="14" rx="3" stroke="currentColor" strokeWidth="1.5"/></svg>
                </div>
                <div>
                  <div className="text-sm font-semibold">Email Us</div>
                  <div className="text-sm text-slate-500">support@evolvetutoring.ai</div>
                </div>
              </li>

              <li className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-cyan-50">
                  <svg className="w-5 h-5 text-cyan-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 16.92V20a2 2 0 0 1-2.18 2 19.86 19.86 0 0 1-8.63-3.07A19.5 19.5 0 0 1 2.11 8.81 19.86 19.86 0 0 1-.96 0 2 2 0 0 1 1 2h3.09a2 2 0 0 1 2 1.72 12.34 12.34 0 0 0 .7 3.21 2 2 0 0 1-.45 2.12L5.7 10.7a16 16 0 0 0 6.6 6.6l2.66-1.65a2 2 0 0 1 2.12-.45 12.34 12.34 0 0 0 3.21.7A2 2 0 0 1 22 16.92z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </div>
                <div>
                  <div className="text-sm font-semibold">Call Us</div>
                  <div className="text-sm text-slate-500">(707)200-8004<br/><span className="text-xs text-slate-400">Mon - Fri, 8 AM - 8 PM</span></div>
                </div>
              </li>

              <li className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-green-50">
                  <svg className="w-5 h-5 text-green-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </div>
                <div>
                  <div className="text-sm font-semibold">Visit Us</div>
                  <div className="text-sm text-slate-500">123 Education Street<br/>Learning City, LC 12345</div>
                </div>
              </li>

              <li className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-orange-50">
                  <svg className="w-5 h-5 text-orange-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 7V3h8v4" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/><rect x="3" y="7" width="18" height="13" rx="2" stroke="currentColor" strokeWidth="1.2"/></svg>
                </div>
                <div>
                  <div className="text-sm font-semibold">Office Hours</div>
                  <div className="text-sm text-slate-500">Mon - Fri: 8 AM - 8 PM<br/>Sat: 9 AM - 5 PM<br/>Sun: Closed</div>
                </div>
              </li>
            </ul>

            <div className="mt-6 text-sm text-slate-500">We typically reply within 1-2 business days.</div>
          </div>
        </div>
      </div>
    </div>
